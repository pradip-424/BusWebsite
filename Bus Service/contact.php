...
<body>
  <section id="header">
    <div class="header container">
        <div class="nav-bar">
            <div class="brand">
                <marquee><a href="#"><h1><span>RAJKOT</span> <span></span>BUS <span>S</span>ERVICE</h1></a></marquee>
            </div>
            <div class="nav-list">
        ...
        <h2>We are glad to contact You</h2>
            ...
            <div class=" w3l-form-group">
                ...
                <div class="group">
                    ...
                    <a href="mailto:rajkotbusservice@network.com" target="_blank"><u style="color:black; font-size:20px"><u>click here to mail US.</u></u></a>
                </div>
            </div>
            <div class=" w3l-form-group">
                <label>Profile :</label>
